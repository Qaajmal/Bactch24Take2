...
@CucumberOptions(
		...
		glue= {"com.dresses.steps"}, // PAKAGE NAME OF YOUR STEP DEFINITION
		tags = {"@Smoketest"},//Tag from the feature file
		plugin = {"com.cucumber.listener.ExtentCucumberFormatter:target/cucumber-reports/report.html"}, // report plug in 
		monochrome = true
		
		)
public class DressesRunner {
